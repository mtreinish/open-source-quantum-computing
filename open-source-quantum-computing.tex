...
\author[Matthew Treinish]{%
    \texorpdfstring{%
        ...
        \href{https://github.com/mtreinish/open-source-quantum-computing/tree/cambridge}{https://github.com/mtreinish/open-source-quantum-computing/tree/cambridge}
   }
   {Matthew Treinish}
}
...
%            \lstinputlisting[basicstyle=\tiny,language=python]{classical_oracle.py}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\frametitle{Where to get more information}
    \begin{itemize}
        \item These Slides: \href{https://github.com/mtreinish/open-source-quantum-computing/tree/cambridge}{https://github.com/mtreinish/open-source-quantum-computing/tree/cambridge}
