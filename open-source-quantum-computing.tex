...
\begin{frame}
    ...
    \item The randomness is in inherent in nature
    \end{itemize}
    \begin{columns}
        \column{.5\textwidth}
            \centering
...
\begin{frame}
    ...
    \begin{itemize}
        \item While qubits are read along the basis vectors
    \end{itemize}
...
\begin{frame}
    ...
    \[
        (\ket{0} + \ket{1})(\ket{0}  - \ket{1}) = \ket{00} - \ket{01} + \ket{10} - \ket{11})
    \]
    \begin{equation*}
        \Qcircuit {
    ...
    \end{equation*}
    \[
        \ket{00} - \ket{01} - \ket{10} + \ket{11} = (\ket{0} {\textbf{\color{red}-}} \ket{1})(\ket{0}  - \ket{1})
    \]
\end{frame}
